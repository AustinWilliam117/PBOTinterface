...
consumer = KafkaConsumer('audiolistening_push_auto',bootstrap_servers='192.168.128.93:9092',group_id='autotest1',auto_offset_reset='latest',enable_auto_commit=True)
consumer1 = KafkaConsumer('audiolistening_push_auto',bootstrap_servers='10.54.0.28:9092',group_id='autotest1',auto_offset_reset='latest',enable_auto_commit=True)
consumer2 = KafkaConsumer('audiolistening_push_auto',bootstrap_servers='10.54.0.32:9092',group_id='autotest1',auto_offset_reset='latest',enable_auto_commit=True)
